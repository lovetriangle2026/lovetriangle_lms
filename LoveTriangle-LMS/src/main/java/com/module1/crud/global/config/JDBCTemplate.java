...
public class JDBCTemplate {
    ...
    static {
        ...
        // JDBCTemplate.class.getClaccLoader() : 클래스를 메모리에 로드하는 역할을 한다.
        ...
        try {
            ...
            // HikariDataSource 를 구성 시 필요한 환경세팅 개체
            ...
            config.setMinimumIdle(5);          // 최소 5개의 커넥션 관리
            config.setMaxLifetime((180000));   // 커넥션을 사용할 수 있는 최대 시간 - 30분 훟 새롭게 생성한다.
